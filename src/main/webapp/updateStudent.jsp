...
<head>
    ...
    <script>
        <%
            JDBCUtil.init();
            ResultSet resultSet = JDBCUtil.selectSql("SELECT * FROM student where id = '"+request.getParameter("id")+"'");
...
<div class="col-md-12 column">
    <form role="form" method="post" action="updateStudentTools.jsp">
        ...
        <div class="form-group">
            ...
            <label><input type="radio" name="sex" value="女" id="exampleInputSex_w">女</label>
        </div>
        <div class="form-group">
